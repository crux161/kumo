...
pub use initrd::{
    entries, entry_paths, entry_table_bytes, find_file, InitrdError, InitrdFile, AUTOEXEC_PATH,
    DRV_BLK_PATH, DRV_FB_PATH, DRV_SERIAL_PATH, FAT32_IMG_PATH, HELLO_PATH, INITRD_HEADER_LEN,
    LS_PATH, PERSONA_LINUX_HELLO_PATH, SORA_INIT_PATH, SVC_HEALTH_PATH, TTYD_PATH,
};
