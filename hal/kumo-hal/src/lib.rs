...
pub mod active {
    pub use kumo_hal_x86_64::{
        ...
        monotonic_nanos, plan_boot_io_apic_timer, probe_io_apic_timer_interrupt, read_phys,
        read_user_aspace_root, reclaim_framebuffer_console, render_qr_diag, render_qr_diag_once,
        run_el0_image, run_el0_smoke, run_ring3_smoke, set_fault_hook, set_framebuffer,
        ...
        timer_irq_count, unmask_boot_io_apic_timer, user_device_page_desc, user_nc_page_desc,
