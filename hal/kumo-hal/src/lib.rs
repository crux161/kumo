...
pub mod active {
    pub use kumo_hal_aarch64::{
        ...
        el0_exit, enable_kernel_mmu, fb_fill, fb_paint_band, framebuffer_console_owned_by_kernel,
        freeze_console, halt, handoff_framebuffer_console, init_timer_interrupts,
        install_exception_vectors, irq_unmask, map_user_device_block, map_user_page,
