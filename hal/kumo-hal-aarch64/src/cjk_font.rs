...
//
//! CJK console glyphs for the Stage-A framebuffer (DESIGN/005), newspaper literacy: Jōyō kanji ∪ GB2312 Level-1 (common simplified Chinese) ∪ Hangul jamo.
//! 4599 glyphs from GNU Unifont, packed as fixed 34-byte records sorted
...
pub const GLYPH_COUNT: usize = 4599;
